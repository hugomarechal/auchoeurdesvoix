...
@section('content')
    ...
    <section style="background-image: url(/images/home/hero/micro.png)" class="bg-[top_left_85%] md:bg-center lg:bg-left bg-cover lg:h-[100vh] lg:flex">
        <div class="flex flex-col md:flex-row-reverse justify-center md:items-center gap-12 w-full px-4 md:px-20 lg:px-0 mx-auto lg:max-w-[1260px] mt-[80%] mb-[100px] md:mt-[250px] lg:mt-[200px]">
            {{--
            ...
            <div data-aos="fade-left" data-aos-duration="1200" class="flex-col items-center justify-center text-start text-white py-8 gap-6 lg:text-start lg:items-start">
                <h1 class=" w-full text-5xl md:max-w-full md:text-6xl lg:text-[74px] font-outfit font-semibold leading-[1.2] mb-px lg:mt-[120px]">
                    Au Chœur des Voix
                </h1>
                <h3 data-aos="fade-left" data-aos-duration="800" class="font-light text-lg md:text-3xl leading-[36px] max-w-[296px] w-full md:max-w-full lg:my-4">
                    Cours et ateliers autour du chant à Marseille
                </h3>
                <a href="#services" class="bg-indigo-400 hover:opacity-80 hover:scale-105 transition-all duration-500 rounded-lg lg:text-2xl font-semibold py-3 px-6 flex w-fit mt-4">
                    Découvrir <img class="ml-4" src="/images/arrow-right.svg" alt="Flèche">
                </a>
            </div>
        </div>
    </section>
    ...
    <section class="relative flex flex-col w-full lg:max-w-[1260px] items-between lg:justify-end px-4 mx-auto mt-[100px] pb-[100px] overflow-x-hidden">
        <div class="w-full lg:max-w-[720px] lg:items-start lg:mb-[120px]">
            ...
            <h5 data-aos="fade-left" data-aos-duration="3000" class="text-indigo-800 text-2xl md:text-2xl mb-10 px-4 font-light">Chanter : une activité extraordinaire, sans artifice <br>et accessible à chacun d'entre nous.<br><br>Notre voix est le reflet de notre être et de nos émotions.<br><br>Le chant est un outil privilégié qui nous pousse à aller chercher au plus profond de nous et partager notre propre vibration avec l’extérieur. <br><br>Cette expérience est amplifiée lorsque l’on chante en groupe, <br>en donnant naissance à une vibration collective, qui nous <br>invite à des ailleurs ressourçants.</h5>
            <div class="lg:flex flex-row gap-6">
                ...
                <div data-aos="fade-up" data-aos-duration="1800" class="border-2 border-indigo-400 bg-white rounded-lg py-6 px-4 mt-4 md:mt-6 md:text-lg">
                    <p>Je suis <span class="text-indigo-800">Carole</span>. Bienvenue dans mon monde ! <br><br>Depuis mes débuts en 2004 au sein d'un orchestre, ma passion pour le chant n'a cessé de croître. <br><br>Je me produis avec différents groupes, explorant ainsi un vaste éventail de styles musicaux, du rock à la soul en passant par le funk, la pop ou le Gospel. <br><br>Je suis impatiente de partager avec vous ma musique et mon énergie lors de nos prochains événements et sessions de chorale !</p>
